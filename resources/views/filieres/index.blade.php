...
<div class="container col-6"><img src="\img\filiere.jpg" class="img-responsive w-50 h-50 d-block mx-auto " alt="logo"></div>
...
<a class="btn btn-success" href="{{ route('filieres.create') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus-fill" viewBox="0 0 16 16">
...
<!-- <a class="btn btn-primary" href="{{ route('filieres.edit',$filiere->id_filiere) }}">Modifier</a> -->
@csrf
@method('DELETE')
