...
<div class="text-center col-4 offset-4 mt-3 mb-1">
    ...
    <div class="row">
       ...
       <h1 class="text-center mt-3 text-light"><i>Veuillez selectionner votre filiere pour acceder à l'emploi du temps</i></h1>
        <hr>
        <div class="col-2 offset-2 mb-2"> <a class="btn btn-dark position " href="{{ route('master.create') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-fill" viewBox="0 0 16 16">
    ...
    <!-- <h2 class="text-center mb-5">***Choix de filière***</h2> -->
            <div class="col-8 offset-4 mb-3">
                ...
                <a class="btn btn-light  mb-2" href="{{ route('ba.index') }}">  <b>BANQUE ET ASSURANCE</b> </a> <br>
                <a class="btn btn-light  mb-2" href="{{ route('ce.index') }}">  <b>AUDIT ET CONTROLE DE GESTION </b> </a><br>
                ...
                <a class="btn btn-light  mb-2" href="{{ route('tl.index') }}">  <b>SCIENCE  ET TECHNIQUES COMPTABLES ET FINANCIERES</b> </a>
            </div>
