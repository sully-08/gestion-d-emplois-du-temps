...
<div class="text-center col-4 offset-4 mt-3 mb-1">
    ...
    <!-- <h2 class="text-center mb-5">***Choix du niveau***</h2> -->
            ...
            <a class="btn btn-light  mb-2" href="{{ route('edt.index') }}">  Licence 1</a><br>
            <a class="btn btn-light  mb-2" href="{{ route('edt.index') }}">   Licence 2</a><br>
            <a class="btn btn-light  mb-2" href="{{ route('edt.index') }}">   Licence 3</a><br>
